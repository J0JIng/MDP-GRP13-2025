...
// application-layer motion logic
namespace AppMotion {
	...
	class Motor {
		public:
			Motor(TIM_HandleTypeDef *ctrl,
				  uint32_t channelA,
				  uint32_t channelB,
				  uint32_t max_period = 2000
				  );
	...
	/* Encoder class that holds encoder info */
	class Encoder {
		public:
	...
	class MotionController {
		...
		#define CENTER_POS_PWM 755   //  756.9 //22 45
		#define LEFT_DELTA 11         // was 10
		#define RIGHT_DELTA 15        // was 10 then 15 20
		#define SLIGHT_LEFT_DELTA 6         // was 10
		#define SLIGHT_RIGHT_DELTA 3        // was 10 then 15 20
